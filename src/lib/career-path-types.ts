...
// Stable onboarding role identity shared across settings, templates, and plans.
export type OnboardingRoleSettingId = OnboardingRoleCode;
...
export interface CareerPathSettings {
  ...
  onboarding_role_settings: OnboardingRoleSettings;
