...
export const defaultOnboardingChecklistTemplates: OnboardingChecklistTemplate[] = [
  { id: 'onb-template-counter-v1', role_code: 'counter_staff', role_label: 'Thu ngân', version: 1, status: 'active', effective_from: '2026-05-27', created_by: 'hr_admin', updated_by: 'hr_admin', created_at: '2026-05-27', updated_at: '2026-05-27', notes: 'Template nền cho Thu ngân take-away.' },
...
export const defaultOnboardingChecklistItems: OnboardingChecklistItemTemplate[] = [
  { id: 'counter-pre-start-basic', template_id: 'onb-template-counter-v1', stage_id: 'onb-template-counter-v1-pre-start', competency_group_id: 'ocg-shift-discipline', code: 'counter_pre_start_briefing', title: 'Nắm giờ có mặt, đồng phục, buddy và nhóm chat', instruction_text: 'Thu ngan phải biết giờ có mặt, đúng đồng phục, ai kèm ca đầu và đã vào nhóm chat ca.', success_criteria: 'Nhắc lại đúng 4 thông tin cơ bản trước ngày vào làm.', training_method: 'read', evidence_type: 'buddy_check', is_required: true, requires_buddy_confirmation: true, requires_manager_confirmation: false, requires_quiz: false, estimated_minutes: 10, sort_order: 1, active: true },
  ...
  { id: 'counter-day-2-3-handover', template_id: 'onb-template-counter-v1', stage_id: 'onb-template-counter-v1-day-2-3', competency_group_id: 'ocg-shift-coordination', code: 'counter_day_2_3_handover', title: 'Bàn giao quầy và giao đơn không nhầm', instruction_text: 'Thu ngan thực hành đóng ly, dán tem, giao đơn và bàn giao cho bar đúng thứ tự.', success_criteria: 'Xử lý 10 đơn mẫu không nhầm món hoặc topping.', training_method: 'observation', evidence_type: 'manager_check', is_required: true, requires_buddy_confirmation: true, requires_manager_confirmation: true, requires_quiz: false, estimated_minutes: 30, sort_order: 3, active: true },
...
export const onboardingMiniQuizTemplates: OnboardingMiniQuizTemplate[] = [
  {
    ...
    title: 'Mini test truoc ngay vao lam',
    questions: [
      {
        id: 'pre-start-q1',
        prompt: 'Khi chua ro gio co mat, ban nen hoi ai truoc?',
        options: [
          { id: 'a', label: 'Buddy hoac quan ly da duoc gan' },
          { id: 'b', label: 'Tu doan theo lich cu' },
          { id: 'c', label: 'Doi den gio roi tinh' },
        ],
        correct_option_id: 'a',
      },
      {
        id: 'pre-start-q2',
        prompt: 'Truoc ngay vao lam, viec nao nen chot som?',
        options: [
          { id: 'a', label: 'Trang phuc, gio co mat, diem check-in va nguoi lien he' },
          { id: 'b', label: 'Chi can biet menu ban chay la du' },
          { id: 'c', label: 'Cho den ca dau moi hoi tung viec' },
        ],
        correct_option_id: 'a',
      },
      {
        id: 'pre-start-q3',
        prompt: 'Neu chua vao nhom chat hoac chua co tai khoan can thiet, ban nen lam gi?',
        options: [
          { id: 'a', label: 'Bao buddy hoac quan ly de duoc bo sung truoc ca dau' },
          { id: 'b', label: 'Bo qua vi vao lam roi tinh sau' },
          { id: 'c', label: 'Tu dung tai khoan chung cua nguoi khac' },
        ],
        correct_option_id: 'a',
      },
    ],
  },
  {
    id: 'onb-quiz-day-1',
    stage_code: 'day_1',
    title: 'Mini test ngay dau',
    questions: [
      {
        id: 'day-1-q1',
        prompt: 'Khi nhan order chua ro topping, ban nen lam gi?',
        options: [
          { id: 'a', label: 'Xac nhan lai voi khach truoc khi bam don' },
          { id: 'b', label: 'Bam theo thoi quen cho nhanh' },
          { id: 'c', label: 'Bo qua topping de do cham' },
        ],
        correct_option_id: 'a',
      },
      {
        id: 'day-1-q2',
        prompt: 'Neu chua nho quy trinh thao tac, cach xu ly dung la gi?',
        options: [
          { id: 'a', label: 'Dung lai va hoi buddy hoac nguoi huong dan ngay' },
          { id: 'b', label: 'Lam thu theo tri nho cho xong' },
          { id: 'c', label: 'Ne tranh viec do den cuoi ca' },
        ],
        correct_option_id: 'a',
      },
      {
        id: 'day-1-q3',
        prompt: 'Sau khi hoan tat thao tac tai quay, dieu nao quan trong nhat?',
        options: [
          { id: 'a', label: 'Don lai khu vuc, giu ve sinh va san sang don tiep' },
          { id: 'b', label: 'Roi quay ngay de tranh viec khac' },
          { id: 'c', label: 'Cho nguoi khac tu thu don' },
        ],
        correct_option_id: 'a',
      },
      {
        id: 'day-1-q4',
        prompt: 'Khi gap tinh huong khach hoi gap ma ban chua chac, ban nen?',
        options: [
          { id: 'a', label: 'Xin phep kiem tra lai voi buddy hoac quan ly roi tra loi' },
          { id: 'b', label: 'Tra loi dai de khach yen tam' },
          { id: 'c', label: 'Im lang va chuyen khach di noi khac' },
        ],
        correct_option_id: 'a',
      },
    ],
...
export const sampleEmployeeOnboardingChecklistPlans: EmployeeOnboardingChecklistPlan[] = [
  { id: "onb-plan-007", employee_id: "emp-007", template_id: "onb-template-counter-v1", role_code: "counter_staff", role_label_snapshot: null, template_label_snapshot: null, assigned_store_id: "store-001", assigned_buddy_id: "emp-006", assigned_buddy_name: "Nguyen Thi Mai", assigned_manager_id: "emp-002", assigned_manager_name: "Tran Thi Lan", start_date: "2025-12-01", current_stage_code: "day_2_3", status: "in_progress", overall_progress: 67, overall_note: "Da qua ca dau, dang can kem them phan ban giao quay.", assigned_at: "2025-11-30", created_at: "2025-11-30", updated_at: "2025-12-03" },
  { id: "onb-plan-017", employee_id: "emp-017", template_id: "onb-template-counter-v1", role_code: "counter_staff", role_label_snapshot: null, template_label_snapshot: null, assigned_store_id: "store-001", assigned_buddy_id: "emp-006", assigned_buddy_name: "Nguyen Thi Mai", assigned_manager_id: "emp-002", assigned_manager_name: "Tran Thi Lan", start_date: "2026-06-03", current_stage_code: "pre_start", status: "assigned", overall_progress: 0, overall_note: null, assigned_at: "2026-06-01", created_at: "2026-06-01", updated_at: "2026-06-01" },
  { id: "onb-plan-018", employee_id: "emp-018", template_id: "onb-template-barista-v1", role_code: "barista", role_label_snapshot: null, template_label_snapshot: null, assigned_store_id: "store-001", assigned_buddy_id: "emp-005", assigned_buddy_name: "Vo Thanh Binh", assigned_manager_id: "emp-002", assigned_manager_name: "Tran Thi Lan", start_date: "2026-05-27", current_stage_code: "day_1", status: "in_progress", overall_progress: 25, overall_note: "Hoan thanh pre-start, bat dau ngay 1.", assigned_at: "2026-05-27", created_at: "2026-05-27", updated_at: "2026-06-01" }
];
...
export const sampleEmployeeOnboardingChecklistProgressItems: EmployeeOnboardingChecklistProgressItem[] = [
  {
    ...
    status: 'passed',
    note: '�� x�c nh?n gi? c� m?t v� v�o nh�m chat.',
  ...
  },
  {
    ...
    status: 'in_progress',
    note: 'C�n nh?m 1 don khi d�ng kh�ch, c?n k�m th�m cu?i ca.',
