  ...
  return (
    <div className="bg-white rounded-2xl p-4 border border-gray-100">
      <div className="flex justify-between gap-1">
        {days.map((day, i) => (
          <div key={i} className={`flex-1 text-center py-3 px-1 rounded-xl transition-all ${day.isToday ? 'bg-gradient-to-br from-primary-700 to-primary-500 text-white shadow-lg shadow-primary-600/30' : day.shift ? 'bg-vanilla-50 hover:bg-primary-50' : 'bg-vanilla-50/50'}`}>
